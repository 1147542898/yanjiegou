<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"/www/wwwroot/svn.yanjiegou.com/public/../application/admin/view/coupon/index.html";i:1562165964;s:72:"/www/wwwroot/svn.yanjiegou.com/application/admin/view/Public/common.html";i:1561105812;s:68:"/www/wwwroot/svn.yanjiegou.com/application/admin/view/Public/js.html";i:1562165964;}*/ ?>
<!doctype html>
    ...
    layui.use(['table','util'], function(){
        ...
        var tableIn = table.render({
            ...
            ,cols: [[ //表头
                ...
                ,{field: 'name', title: '名称'}
                ,{field: 'type_id', title: '类型',width:80}
                ,{field: 'shopname', title: '商家名称'}
                ,{field: 'min_price', title: '最低消费金额'}
                ,{field: 'sub_price', title: '优惠金额'}
                ...
                layer.confirm('您确定要删除该内容吗？', function(index){
                    ...
                    $.post("<?php echo url('listDel'); ?>",{id:data.id},function(res){
                        ...
                        if(res.code===1){
                            ...
                            tableIn.reload({where:{type:'<?php echo input("type"); ?>'}});
                        }else{

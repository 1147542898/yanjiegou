<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:79:"/www/wwwroot/svn.yanjiegou.com/public/../application/admin/view/shop/admin.html";i:1561446720;s:72:"/www/wwwroot/svn.yanjiegou.com/application/admin/view/Public/common.html";i:1561105812;s:68:"/www/wwwroot/svn.yanjiegou.com/application/admin/view/Public/js.html";i:1562165964;}*/ ?>
<!doctype html>
...
<!--js结束-->
<script>    layui.use(['form','jquery'], function () {        var form = layui.form,            $ = layui.jquery;        //自定义验证规则        form.verify({        });        //监听提交        form.on('submit(submit)', function (data) {            var loading = layer.load(1, {shade: [0.1, '#fff']});            $.post("", data.field, function (res) {                layer.close(loading);                if (res.code > 0) {                    layer.msg(res.msg, {time: 1800, icon: 1}, function () {                        location.href = '<?php echo url("admin/shop/index"); ?>';                    });                } else {                    layer.msg(res.msg, {time: 1800, icon: 2});                }            });        });    });    </script>

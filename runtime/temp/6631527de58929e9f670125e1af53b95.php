<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:89:"D:\phpstudy123\PHPTutorial\WWW\yanjiegou\public/../application/shop\view\login\index.html";i:1570671125;}*/ ?>
<!doctype html>
...
<body class="login-bg">
    ...
    <div class="login layui-anim layui-anim-up">
        <div class="message" style="font-size: 24px; background-color: #1E9FFF">沿街购-商家端登录</div>
        ...
        <form method="post" class="layui-form" >
            ...
            <input value="登录"  lay-submit id="btn" lay-filter="login" style="width:100%; background-color: #1E9FFF" type='button'>
            <hr class="hr20" >
        </form>
    </div>
                ...
                $.post("<?php echo url("","",true,false);?>", data.field, function (res) {
                    ...
                    if (res.code > 0) {
                        layer.msg(res.msg, {time: 1800, icon: 1}, function () {
                            location.href = "<?php echo url('shop/index/index'); ?>";
                        });
                    } else {
